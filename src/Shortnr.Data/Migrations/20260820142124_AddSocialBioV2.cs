        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FollowerCount = table.Column<long>(type: "INTEGER", nullable: true),
                    SubscriberCount = table.Column<long>(type: "INTEGER", nullable: true),
                    AccessTokenEncrypted = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    RefreshTokenEncrypted = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    SocialAccountId = table.Column<long>(type: "INTEGER", nullable: false),
                    ExternalPostId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    ...
                    Permalink = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
