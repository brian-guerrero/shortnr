...
/// also offered as redirect-preview themes (see <c>PreviewThemes</c>); "minimal",
/// "corporate" and "dark" originate on the preview side and are mirrored here so
/// both surfaces share one theme-name vocabulary.
/// </summary>
