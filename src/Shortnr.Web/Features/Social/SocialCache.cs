...
public class SocialCache : ISocialCache
{
    ...
    public void Set(long socialAccountId, SocialData data)
    {
        ...
        // (a long, generated by the DB), not a credential or PII. CodeQL's
        // cs/cleartext-storage-of-sensitive-information heuristic flags it purely
        // because the parameter name contains "account" — logging it is deliberate:
        // it's the join key needed to correlate cache activity with a specific
    ...
    public void Invalidate(long socialAccountId)
    {
        ...
        // See the justification on Set() above — same false positive.
        // codeql[cs/cleartext-storage-of-sensitive-information]
